...
import org.springframework.boot.test.context.filter._FactoryProvider;
...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(ContextCustomizerFactory.class, () -> _FactoryProvider.excludeFilterContextCustomizerFactory());
