...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.dockerdemo.DockerDemoApplicationTests", () -> new AotSpringBootConfigContextLoader(DockerDemoApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.dockerdemo.DockerDemoApplicationTests", DockerDemoApplicationTestsContextInitializer.class);
    return entries;
  }
}
